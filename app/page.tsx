          ...
          <div className="flex shrink-0 items-center gap-1.5">
            ...
            {status === "loading" ? (
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl bg-zinc-900 px-3.5 py-2 text-xs font-medium text-white shadow-sm transition-colors hover:bg-zinc-800 dark:bg-zinc-700 dark:hover:bg-zinc-600"
              >
