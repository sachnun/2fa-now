      ...
      <svg className="h-6 w-6 -rotate-90" viewBox="0 0 24 24">
        ...
        <circle
          ...
          className={`transition-all duration-1000 ease-linear ${
            timeLeft <= 5 ? "text-red-500" : "text-zinc-500 dark:text-zinc-400"
          }`}
        />
      </svg>
    </div>
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      {/* Sticky Header Bar */}
      <header className="sticky top-0 z-30 bg-zinc-50/70 backdrop-blur-xl after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-gradient-to-r after:from-transparent after:via-zinc-300 after:to-transparent dark:bg-zinc-950/70 dark:after:via-zinc-800">
        <div className="mx-auto flex max-w-6xl items-center gap-4 px-4 py-4 sm:px-6 lg:px-8">
              ...
              <form onSubmit={handleLabelSubmit} className="flex items-center gap-2">
                <div className="relative min-w-0 flex-1">
                  <input
                    ...
                    className="w-full rounded-xl border-0 bg-white px-4 py-2.5 text-sm text-zinc-900 placeholder-zinc-400 shadow-sm ring-1 ring-zinc-200 focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:bg-zinc-800/80 dark:text-zinc-100 dark:placeholder-zinc-600 dark:ring-zinc-700/50 dark:focus:ring-zinc-500"
                  />
                </div>
                <button
                  type="submit"
                  className="shrink-0 rounded-xl bg-zinc-900 px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-zinc-800 dark:bg-zinc-600 dark:hover:bg-zinc-500"
                >
                  Add
                </button>
                <button
              ...
              <form onSubmit={handleSubmit}>
                <div className="relative">
                  ...
                  <input
                    ...
                    onPaste={handlePaste}
                    className={`w-full rounded-xl border-0 bg-white px-4 py-2.5 font-mono text-sm text-zinc-900 shadow-sm ring-1 focus:outline-none focus:ring-2 dark:bg-zinc-800/80 dark:text-zinc-100 ${
                      inputError
                        ? "ring-red-500 focus:ring-red-500 dark:ring-red-500 dark:focus:ring-red-500"
                        : "ring-zinc-200 focus:ring-zinc-400 dark:ring-zinc-700/50 dark:focus:ring-zinc-500"
                    }`}
                  />
                </div>
              </form>
          ...
          <div className="flex shrink-0 items-center gap-1.5">
            {mounted && (
              <>
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-xl p-2 text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-700 dark:hover:bg-zinc-800/60 dark:hover:text-zinc-300"
                  title="Import"
                >
            ...
            {status === "loading" ? (
              ...
              <button
                onClick={() => signOut()}
                className="flex cursor-pointer items-center gap-1.5 rounded-xl p-2 text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-700 dark:hover:bg-zinc-800/60 dark:hover:text-zinc-300"
              >
                {syncing ? (
              ...
              <button
                ...
                className="flex cursor-pointer items-center gap-1.5 rounded-xl bg-zinc-900 px-3.5 py-2 text-xs font-medium text-white shadow-sm transition-colors hover:bg-zinc-800 dark:bg-zinc-700 dark:hover:bg-zinc-600"
              >
      ...
      {shareModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" onClick={() => setShareModal(null)}>
          <div className="mx-4 w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl dark:bg-zinc-900" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center gap-2 rounded-xl bg-zinc-100 p-3 dark:bg-zinc-800">
              <input
                type="text"
                readOnly
